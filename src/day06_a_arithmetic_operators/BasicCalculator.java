...
public class BasicCalculator {
    public static void main(String[] args) {
        ...
        // If we have 2 data types (int and double), the system will promote the biggest automatically BY DEFAULT
        ...
        SUBSTRACTION     -  Subtracts one value from another              10 - 5 = 5
        DIVISION           /  Divides two values                          10 / 5 = 2
        MULTIPLICATION   *  Multiplies two values                         10 * 5 = 50
        MODULUS          % Divides two values and returns the reminder    10 % 3 = 1
         */
